...
public class Entity {
	...
	public static boolean hunt(RobotType type, Team t, RobotController rc) throws GameActionException {
		RobotInfo[] enemies = rc.senseNearbyRobots(Integer.MAX_VALUE, t);
	...
	public static boolean huntList(RobotType[] types, Team t, RobotController rc) throws GameActionException {
